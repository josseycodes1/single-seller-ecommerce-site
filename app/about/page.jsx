            ...
            <div className="px-6 md:px-16 lg:px-32 pt-14">
                ...
                <div className="bg-gradient-to-r from-josseypink2 to-josseypink1 text-white py-16 rounded-lg mb-12">
                    <div className="max-w-4xl mx-auto text-center">
                        <h1 className="text-4xl md:text-5xl font-bold mb-4">About JosseyCart</h1>
                        <p className="text-xl opacity-90">Your trusted partner in quality products and exceptional service</p>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-gray-600 mb-4 leading-relaxed">
                                Founded in 2020, JosseyCart began as a small startup with a big vision: to bring 
                                high-quality products to customers worldwide at affordable prices. What started 
                                as a humble online store has grown into a trusted ecommerce platform serving 
                                thousands of satisfied customers.
                            </p>
                            <p className="text-gray-600 mb-4 leading-relaxed">
                                Our journey has been fueled by passion, innovation, and an unwavering commitment 
                                to customer satisfaction. We carefully curate every product in our catalog, 
                                ensuring they meet our strict quality standards before reaching your doorstep.
                            </p>
                            <p className="text-gray-600 leading-relaxed">
                                Today, we continue to evolve, embracing new technologies and trends to provide 
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="text-center p-6 bg-white rounded-lg shadow-sm border">
                            ...
                            <p className="text-gray-600">
                                We never compromise on quality. Every product is thoroughly vetted to ensure 
                        ...
                        <div className="text-center p-6 bg-white rounded-lg shadow-sm border">
                            ...
                            <p className="text-gray-600">
                                We continuously improve our platform and services to enhance your shopping 
                                experience.
                            </p>
                        </div>
                    </div>
