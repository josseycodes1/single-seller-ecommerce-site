  ...
  if (loading) {
    return (
      <div className="mt-14">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-14 mt-12 md:px-14 px-4">
          {Array.from({ length: 3 }).map((_, index) => (
            <div key={index} className="relative group overflow-hidden rounded-lg">
              {/* skeleton image */}
              <div className="relative w-full h-64 bg-gray-200 animate-pulse rounded-lg"></div>
              
              {/* skeleton overlay details */}
              <div className="absolute bottom-8 left-8 space-y-2">
                <div className="h-6 bg-gray-300 rounded w-40 animate-pulse"></div>
                <div className="h-4 bg-gray-300 rounded w-60 animate-pulse"></div>
        ...
        {/* skeleton see more button */}
        <div className="flex justify-center mt-12">
          <div className="px-12 py-2.5 border rounded bg-gray-200 animate-pulse w-40 h-10"></div>
        </div>
      </div>
    );
  }
