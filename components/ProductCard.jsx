    ...
    <div className="flex flex-col items-start gap-0.5 max-w-[200px] w-full">
      ...
      <div className="flex items-center justify-between w-full mt-2 min-h-[40px]">
        ...
        <button
          ...
          className="px-3 py-1.5 text-white border border-gray-500/20 rounded text-xs hover:bg-josseypink2 bg-josseypink2 transition-colors duration-200 whitespace-nowrap flex-shrink-0"
        >
