...
const MobileSearchBar = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="md:hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-start justify-center pt-20 px-4">
      <div 
        ref={containerRef}
        className="bg-white rounded-lg shadow-xl w-full max-w-md mobile-search-container"
      >
        {/* Search Header */}
        <div className="flex items-center gap-3 p-4 border-b border-gray-200">
          <div className="flex-1 flex items-center border rounded-full px-4 py-2 bg-white">
            <input
              ref={inputRef}
              type="text"
